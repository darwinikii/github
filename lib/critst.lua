--[[
    made by the one and only sexy beast named icee :troll:
    ps: cyclops is in the kitchen :lol:
]]
...
-- UILib
local Library           = loadstring(game:HttpGet("https://Last-HUB.darwinikii.repl.co/lib/uilib.lua"))();
